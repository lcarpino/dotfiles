...
;; requires: emacs27
;; synced with spacemacs template: 2022-03-27
;; git commit hash: 18ad9759b29a56ba92fe452b62dd545329175b63

;;;; Introduction
;; Factoring out some of my configuration into separate variables to try and
;; make everything more maintainable.

;;;; layers

(setq dotspacemacs/layers/core
      ;; core _spacemacs_ configuration
      '(helm
        better-defaults
        git
        (org :variables
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-mode-line-theme '(doom :separator wave :separator-scale 0.5)
